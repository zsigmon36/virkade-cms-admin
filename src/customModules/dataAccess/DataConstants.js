...
export const GET_ALL_USER_PLAY_SESSIONS = 'getAllUserSessions'
...
export const UPDATE_USER_SESSION = 'updateUserSession'
...
export const ADMIN_USER_TYPE_CODE = 'ADMN'
export const GENERAL_COMMENT_TYPE_CODE = 'GNRL_CMNT'
export const CONDITIONS_COMMENT_TYPE_CODE = 'CNDTN_CMNT'
export const PHYSICAL_ADDRESS_TYPE_CODE = 'PHYSCL_ADRS'
export const MOBILE_PHONE_TYPE_CODE = 'MBLE_PHNE'
...
export const ACTIVE_TC_LEGAL = 'ActiveTCLegal'
export const ACTIVE_LIAB_LEGAL = 'ActiveLiabLegal'
export const GSIG = 'gSig'
export const PSIG = 'pSig'
...
export const DATE_REQUESTED = 'dateRequested'
...
export const APPRV_CODE = "approvalCode"
